...
(
    ...
    year                    int                     not null,
    general_total_count     int       default 0     not null,
    general_used_count      int       default 0     not null,
    alternative_total_count int       default 0     not null,
    alternative_used_count  int       default 0     not null,
